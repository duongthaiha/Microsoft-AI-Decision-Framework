...
> **Problem-first reminder:** Start with the business outcome and scenario, then pick the simplest technology that satisfies it. Use [Scenarios](SCENARIOS.md) to anchor real problems and the [Decision Framework](DECISION_FRAMEWORK.md) to gate technology choices.
...
**Next:** [Feature Comparison](FEATURE_COMPARISON.md) - Side-by-side capability matrices
