...
Before moving to the [Implementation Patterns](IMPLEMENTATION_PATTERNS.md), confirm you have scored the scenario:

**Lifecycle:**

* [ ] Technology status (GA/Preview/Deprecated) confirmed against [Quick Reference: Lifecycle Status](QUICK_REFERENCE.md)?
...
**Next:** [Implementation Patterns](IMPLEMENTATION_PATTERNS.md) - Apply the scoring outcomes to pick execution patterns
