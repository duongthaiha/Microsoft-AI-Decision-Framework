...
For a detailed intake workflow, see [Decision Framework](DECISION_FRAMEWORK.md).
...
**Next:** [Decision Framework](DECISION_FRAMEWORK.md) - Apply BXT and critical questions to shortlist technologies
