...
{: .note }
Detailed side-by-side comparisons of Microsoft AI technologies. Use this page after you’ve clarified requirements in the [Decision Framework](DECISION_FRAMEWORK.md), so the tables confirm trade-offs (rather than driving the decision by brand names alone).
...
> Related Pages
>
> - For technology selection guidance, see [Decision Framework](DECISION_FRAMEWORK.md)    
> - For fast lookup tables, see [Quick Reference](QUICK_REFERENCE.md)
> - For architecture patterns, see [Implementation Patterns](IMPLEMENTATION_PATTERNS.md)

---

**Next:** [Quick Reference](QUICK_REFERENCE.md) - Fast lookup tables to accompany the matrices
