...
>
> These tables help you validate technology choices **after** you've completed the [Decision Framework](DECISION_FRAMEWORK.md) assessment. Selecting technologies without understanding your Business requirements, user eXperience needs, and Technology constraints often leads to suboptimal outcomes: either overpowered solutions that exceed budget, or underpowered solutions requiring costly rewrites.
>
> **First time here?** Start with [Decision Framework](DECISION_FRAMEWORK.md) to build a systematic approach to technology selection.
...
*Data architecture principle: anchor grounding in governed data (OneLake/Fabric/Foundry) with clear landing zones.*
...
- **Unified Pre-Purchase (P3):** Agent Commit Units (ACUs) in a single pool covering both Copilot Studio and Foundry; best when workloads span both platforms. See [Evaluation Criteria: Budget](EVALUATION_CRITERIA.md#3-budget-assessment)
...
> Quick Navigation
>
> - For decision logic behind these recommendations, see [Decision Framework](DECISION_FRAMEWORK.md)
> - For detailed architecture patterns, see [Implementation Patterns](IMPLEMENTATION_PATTERNS.md)
> - For real-world examples, see [Scenarios](SCENARIOS.md)

---

**Next:** [Resources](RESOURCES.md) - Official Microsoft references to keep research evidence-backed
