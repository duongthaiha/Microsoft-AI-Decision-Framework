...
**Cross-references:** [Pattern 9: Foundry Agent → M365 Copilot Publish Path](IMPLEMENTATION_PATTERNS.md#pattern-9-foundry-agent--m365-copilot-publish-path), [Evaluation Criteria: Lifecycle & Operational Readiness](EVALUATION_CRITERIA.md)
...
**Cross-references:** [Work IQ](TECHNOLOGIES.md#work-iq-preview), [Pattern 1: Start in Studio, Scale with Azure](IMPLEMENTATION_PATTERNS.md#pattern-1-start-in-studio-scale-with-azure)
...
→ [Evaluation Criteria](EVALUATION_CRITERIA.md) to assess requirements

**Need detailed technology comparison?**  
→ [Feature Comparison](FEATURE_COMPARISON.md) for side-by-side analysis

**Need implementation patterns?**  
→ [Implementation Patterns](IMPLEMENTATION_PATTERNS.md) for architecture guidance

---

**Last Updated:** March 19, 2026  
**Next:** [Implementation Patterns](IMPLEMENTATION_PATTERNS.md) - Convert the scenario into an architecture pattern
